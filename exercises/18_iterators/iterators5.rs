...
fn count_iterator(map: &HashMap<String, Progress>, value: Progress) -> usize {
    //NOTE: fold means return the accumulator value after running a closure over every iterator val
...
fn count_collection_iterator(collection: &[HashMap<String, Progress>], value: Progress) -> usize {
    collection.iter().fold(0, |acc, nested| {acc + count_iterator(nested, value)})
